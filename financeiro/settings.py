...
SECRET_KEY = 'django-insecure-^jo+jz481i_g0k0j^m8l1j4wt++8!tg2$kpocj5l0n1z$!slr0'
...
# Depois de logar, vai para a lista de despesas
LOGIN_REDIRECT_URL = 'lista_despesas'

# Depois de deslogar, volta para a tela de login
LOGOUT_REDIRECT_URL = 'login'


def abrir_navegador(*args, **kwargs):
    def _open():
